...
public final class OsmLayerParam extends AbstractTiledLayerParams {
  ...
  private static final Double[] DEFAULT_RESOLUTIONS =
      new Double[] {
        156543.03390625,
        78271.516953125,
        39135.7584765625,
   ...
   *
   * <ul>
   *   <li>The base part of the URL, for example 'http://tile.openstreetmap.org'. This results in an
  ...
  public Envelope getMaxExtent() {
    ...
    final int maxY = 3;
    return new Envelope(
        this.maxExtent[minX], this.maxExtent[minY], this.maxExtent[maxX], this.maxExtent[maxY]);
  }
